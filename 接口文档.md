...
### 3.获取某学生的课程信息
  1. 请求方式和链接地址：get/student_course.php [示例链接](http://127.0.0.1/student_course.php?student_id=1)
  2. 输入参数：
    * student_id：int 学生ID
  3. 输出参数：
    * code:int 状态码
...
```
 ...
 ### 5.获取某教师所要教授的课程信息
  1. 请求方式和链接地址：get/teacher_course.php [示例链接](http://127.0.0.1/teacher_course.php?teacher_id=1)
  2. 输入参数：
    * teacher_id：int 教师ID
  3. 输出参数：
    * code:int 状态码
